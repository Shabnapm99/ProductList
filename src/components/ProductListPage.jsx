            ...
            <div className="W-full md:basis-2/4 flex flex-col gap-4">
                <div id="title">
                    ...
                    <div className="flex items-center gap-5">
                        <button className="bg-green-700 rounded-md w-auto h-5 p-1 text-white text-[9px] lg:text-[11px] font-medium flex justify-center items-center gap-1.5 max-w-full">{props.rating}
            ...
            <div className='W-full md:basis-1/4 pr-0 md:pr-10'>
                ...
                <div>
                    <div className="flex gap-3">
                        ...
                        <p className="text-green-700 font-medium text-[7px] md:text-[9px] lg:text-sm">{props.offerPercentage}% off</p>
                    </div>
