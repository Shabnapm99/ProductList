        ...
        <nav className='flex w-full justify-center'>
            <div className='basis-1/2 flex justify-center lg:justify-end gap-2 lg:gap-5'>
                ...
                <div className='relative'>
                    <input type='text' placeholder='Search for Products, Brands and more' className='text-[8px] md:[10px] lg:text-sm bg-white w-50 lg:w-80 py-1 px-2.5 lg:py-1.5 lg:px-4 rounded' />
            ...
            <div className='basis-1/2 flex items-center justify-center gap-3 lg:gap-12 '>
                <button className='text-[8px] md:[10px] lg:text-sm font-semibold bg-white text-blue-600 px-3 lg:px-8 rounded py-0.5 flex '>Login</button>
