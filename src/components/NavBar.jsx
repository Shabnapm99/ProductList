    ...
    return (
        <nav className='flex w-full justify-center'>
            <div className='basis-1/2 flex justify-center lg:justify-end gap-2 lg:gap-5'>
                <div className='w-[14%] lg:h-[80%] h-[60%] flex justify-center items-center lg:mt-1 mt-2 ml-1'>
            ...
            <div className='basis-1/2 flex items-center justify-center gap-3 lg:gap-12'>
                ...
                <button className='block cursor-pointer md:hidden text-xl ml-10' onClick={() => setIsSmallScreen(!isSmallScreen)}>
                    <FontAwesomeIcon icon={faBars} className=' text-gray-300 ' /></button>
                <ul className={`  ${isSmallScreen ? 'flex flex-col absolute top-full right-0 w-1/4 bg-blue-500 py-4 px-2 overflow-hidden transition-all duration-500 ease-in-out' : 'hidden lg:flex'} justify-between items-center gap-2 lg:gap-8 text-[8px] md:text-[10px] lg:text-sm font-semibold text-white`} >
